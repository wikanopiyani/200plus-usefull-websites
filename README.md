...
[![206 Most Useful Websites](https://public-files.gumroad.com/q1v8t5h8kl73wyx2648mpplau4rq)](https://statuesque-duckanoo-0fd3d0.netlify.app/)

This repo has **15 free picks** from the guide. The full **206-website PDF** (17 categories, 130 pages, a screenshot and a clear breakdown of every site) is available here:
**[Get the full guide on Gumroad](https://wikanopi.gumroad.com/l/best-websites-list)**
...
- [3D, CAD & Mapping](#3d-cad--mapping)
- [Home & Interior Design](#home--interior-design)
- [Science & Engineering](#science--engineering)
- [Coding & Developer Tools](#coding--developer-tools)
- [Cars & Repair](#cars--repair)
- [Health, Fitness & Food](#health-fitness--food)
- [Music & Audio](#music--audio)
- [Tabletop & Game Maps](#tabletop--game-maps)
- [Travel & Exploration](#travel--exploration)
- [Games & Fun](#games--fun)
- [Art & Creative Reference](#art--creative-reference)
- [Get the full list](#get-the-full-list)

## AI Builders & Generators
...
- Converts text into diagrams and infographics
- Editable styles, icons and content
- Export as PNG or SVG

💡 **Try this:** Paste your project summary and turn it into a clean process diagram for tomorrow's slide deck.
...
- Sky replacement and background blur
- Image upscaling and format conversion

💡 **Try this:** Remove a messy background from a product photo and replace it with clean white for your online store.
...
- Vast library of 3D models
- Interactive 3D and VR viewer
- Free and paid downloads

💡 **Try this:** Use it to download a detailed car model for a Blender animation project.
...
- Room builder with real dimensions
- Drag in actual IKEA products
- View from any 3D angle

💡 **Try this:** Use it to test whether a new IKEA sofa and shelving fit your living room.
...
- Physics, chemistry, biology and math sims
- Adjustable experiment parameters
- Runs in any modern browser

💡 **Try this:** Use it to build a virtual circuit and see how resistance affects current.
...
- Virtual boards, sensors and displays
- Run real code in simulation
- Library of example projects

💡 **Try this:** Prototype an ESP32 weather station and debug the code before ordering any parts.
...
- Tracks for many programming languages
- Beginner to advanced exercises
- Free volunteer mentoring

💡 **Try this:** Work through the Rust track's exercises to pick up a new language for your next project.
...
- Step-by-step photo repair guides
- Full tool and parts list per guide
- Covers phones, laptops, consoles and more

💡 **Try this:** Use it to replace a worn-out phone battery at home instead of paying for a service visit.
...
- Interactive muscle body map
- Exercise videos filtered by equipment
- Quick workout plan builder

💡 **Try this:** Select your core and the dumbbells you own to get a targeted ab workout for tonight.
...
- Traditional recipes and dish origins
- Local restaurant recommendations

💡 **Try this:** Find the must-try local dishes and best restaurants before your trip to Italy.
...
- Pitch, tempo and key tools
- Audio cutter and joiner included

💡 **Try this:** Use it to create a karaoke track of your favorite song.
...
- Randomly generated fantasy worlds
- Editable states, cultures and cities
- Detailed city maps on click

💡 **Try this:** Generate a new continent for your D&D campaign and customize the capital city your players will visit.
...
- Real-world global scenery
- Keyboard or mouse controls

💡 **Try this:** Fly a small plane over your hometown to see it from above.
...
- Change season and time of day
- Runs instantly in any browser

💡 **Try this:** Unwind after a long day with a snowy night drive through endless mountain roads.

## Art & Creative Reference
...
- Interactive camera setting lessons
- Aperture, shutter and white balance
- Lighting setup breakdowns

💡 **Try this:** Use it to learn how shutter speed affects motion blur before a sports shoot.

## Get the full list

The complete guide has **206 websites** across **17 categories**:

| Category | Websites |
|---|---|
| AI Builders & Generators | 12 |
| Design & Graphics | 22 |
| Animation & Motion | 14 |
| 3D, CAD & Mapping | 14 |
| Home & Interior Design | 8 |
| Learning & Education | 13 |
| Science & Engineering | 19 |
| Coding & Developer Tools | 8 |
| Everyday Utilities & File Tools | 17 |
| Cars & Repair | 7 |
| Health, Fitness & Food | 7 |
| Music & Audio | 8 |
| Crafts, Sewing & DIY | 8 |
| Tabletop & Game Maps | 7 |
| Travel & Exploration | 8 |
| Games & Fun | 21 |
| Art & Creative Reference | 13 |
...
All listed websites and trademarks belong to their respective owners. This list is independent and not affiliated with any listed site.
